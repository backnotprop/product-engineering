...
description: The JSON a pe-verify run produces, and the rules the validator enforces.
sidebar:
  order: 1
---
...
Authored in the kit. Source: [skills/pe-verify/references/report-schema.md](https://github.com/backnotprop/product-engineering/blob/main/skills/pe-verify/references/report-schema.md), rendered as-is at build time.
