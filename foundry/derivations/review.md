...
| audit-method.md | ibelick/ui-skills · skills/improve-ui/SKILL.md | SOLID | verbatim-minus | KEEP: falsification pass, three-proof gate, read-only discipline. CUT (patch): the a11y-discard rule and the stop-at-three cap — both overruled by L-09 |
...
- **L-09**: audit-method.md patch cuts the a11y-discard and stop-at-three rules.
